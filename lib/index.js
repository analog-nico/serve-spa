...
module.exports = function initServeSpa(app, root, options) {
    ...
    function serveSpaPrepare(req, res, next) {
        ...
        if (req._parsedUrl.pathname.match(/\/(index.htmlt|compose.js)$/i) !== null) {
    ...
    app.use(serveSpaPrepare);
    app.use(serveSpaBefore);
    app.use(serveSpaCompose);
    app.use(serveSpaRender);
